...
class ReferenceGenerator:
    ...
    def __init__(self):
        ...
        v_list = rospy.get_param('~v_list', default=[8])
        ...
        loop_r = rospy.get_param('~loop_r', default=5.0)
        loop_z = rospy.get_param('~loop_z', default=2.5)
        z_dim = rospy.get_param('~z_dim', default=0)
        loop_v_max = rospy.get_param('~loop_v_max', default=8)
